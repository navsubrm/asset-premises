...
type PageDocumentDataSlicesSlice = BasicHeroSlice | RichTextSlice;
...
export interface BasicHeroSliceDefaultPrimary {
	/**
	 * Main Title field in *BasicHero → Default → Primary*
	 *
	 * - **Field Type**: Title
	 * - **Placeholder**: *None*
	 * - **API ID Path**: basic_hero.default.primary.main_title
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	main_title: prismic.TitleField;

	/**
	 * Sub Title field in *BasicHero → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: basic_hero.default.primary.sub_title
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
